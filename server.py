...
def append_text_block(target_blocks: List[Dict[str, Any]], text: str) -> None:
    """Append text to a list of OpenAI-style content blocks, merging adjacent text blocks."""
    if not text:
        return
...
def flush_user_content(messages: List[Dict[str, Any]], content_blocks: List[Dict[str, Any]]) -> None:
    """Flush accumulated user content blocks into a message."""
            ...
            if msg.role == "assistant":
                ...
                for block in content:
                    ...
                    if block_type == "text":
                        ...
                        # Preserve unexpected user-side tool markers as text instead of losing them.
                        append_text_block(
                            user_content_blocks,
...
def convert_litellm_to_anthropic(litellm_response: Union[Dict[str, Any], Any], 
    ...
    try:
        ...
        # Always expose tool calls using Anthropic content blocks because the proxy
        # speaks the Anthropic protocol to the client regardless of backend model.
        if tool_calls:
        ...
        if "openai" in litellm_request["model"] and "messages" in litellm_request:
            ...
            for i, msg in enumerate(litellm_request["messages"]):
                ...
                if "content" in msg:
                    ...
                    elif msg["content"] is None and not msg.get("tool_calls"):
